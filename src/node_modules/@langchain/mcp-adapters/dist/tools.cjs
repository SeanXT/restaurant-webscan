...
exports.loadMcpTools = exports.isToolException = exports.ToolException = void 0;
...
async function loadMcpTools(serverName, client, options) {
    const { throwOnLoadError, prefixToolNameWithServerName, additionalToolNamePrefix, useStandardContentBlocks, outputHandling, } = {
