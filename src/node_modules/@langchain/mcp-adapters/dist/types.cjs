...
exports._resolveAndApplyOverrideHandlingOverrides = exports._resolveDetailedOutputHandling = exports.clientConfigSchema = exports.connectionSchema = exports.streamableHttpConnectionSchema = exports.streamableHttpReconnectSchema = exports.stdioConnectionSchema = exports.stdioRestartSchema = exports.oAuthClientProviderSchema = exports.outputHandlingSchema = exports.callToolResultContentTypeSchema = void 0;
...
exports.clientConfigSchema = zod_1.z
     ...
     * environment.
     */
    outputHandling: exports.outputHandlingSchema.optional().default({
        text: "content",
        image: "content",
        audio: "content",
        resource: "artifact",
